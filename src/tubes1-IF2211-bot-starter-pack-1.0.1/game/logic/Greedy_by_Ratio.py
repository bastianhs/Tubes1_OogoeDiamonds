...
# Bot akan memilih diamond yang memiliki rasio (jarak : point) terkecil
    ...
    def next_move(self, board_bot: GameObject, board: Board):
        ...
        self.goal_position = search_diamond_with_minimum_ratio(board_bot, board)       
...
# Mengembalikan posisi diamond button jika tidak ada diamond yang tersedia
    ...
    diamond_button: Position = get_diamond_button(board)
...
def get_diamond_button(board: Board) -> Position :
